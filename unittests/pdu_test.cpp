...
TEST(PduTest, packet) {
    ...
    ASSERT_TRUE(pdu_decode(packet.data(), packet.size()));
...
TEST(PduTest, other) {
    const auto packet = hex2vector("0F004B80 6E0C07E8 0A1C0117 1400FF80 00000206 01060204 12002809 06000919 0900FF0F 02120000 02041200 28090600 09190900 FF0F0112 00000204 12000309 06010101 0801FF0F 02120000 02041200 03090601 01010802 FF0F0212 00000204 12000309 06010102 0801FF0F 02120000 02041200 03090601 01020802 FF0F0212 00000906 00091909 00FF0600 1EDFFC06 001E9F8F 06000000 00060000 0000");
    ASSERT_TRUE(pdu_decode(packet.data(), packet.size()));
}
